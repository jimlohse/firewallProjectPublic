...
file_id = { rules_file = 'rules/file_magic.rules' }
file_policy = { }
...
ips =
{
    ...
    rules = [[
        include /etc/snort/rules/black_list.rules
	include /etc/snort/rules/white_list.rules
	include /etc/snort/rules/cs6035.rules
    ]],
...
-- daq = { modules = { { name = 'nfq', mode = inline, interface = 'eth0' } } }

daq = {
    modules = {
        {
     	    name = 'nfq',              -- Use the nfq DAQ module
            mode = 'inline'           -- Mode set to inline for IPS
        }
    }
}
...
--alert_csv = { }
alert_fast = {packet = true, buffers = rule, file = true} -- , filename = '/var/log/snort/alert_fast.txt' }
-- alert_fast = { file = /var/log/snort.alert.fast }
--alert_full = { }
--alert_sfsocket = { }
--alert_syslog = { }
--unified2 = { }
